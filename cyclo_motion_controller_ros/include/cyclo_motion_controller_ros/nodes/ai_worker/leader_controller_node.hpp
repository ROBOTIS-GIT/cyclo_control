...
private:
  ...
  std::string right_teleop_enable_topic_;
  std::string left_teleop_enable_topic_;
  ...
  rclcpp::Subscription<std_msgs::msg::Bool>::SharedPtr right_teleop_enable_sub_;
  rclcpp::Subscription<std_msgs::msg::Bool>::SharedPtr left_teleop_enable_sub_;
  ...
  bool right_teleop_enabled_ = false;
  bool left_teleop_enabled_ = false;
  ...
  void rightTeleopEnableCallback(const std_msgs::msg::Bool::SharedPtr msg);
  void leftTeleopEnableCallback(const std_msgs::msg::Bool::SharedPtr msg);
