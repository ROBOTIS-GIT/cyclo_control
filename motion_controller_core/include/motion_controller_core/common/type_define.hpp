...
{
namespace common    // NOLINT(runtime/indentation_namespace)
{
    // 6D twist / spatial vector
using Vector6d = Eigen::Matrix<double, 6, 1>;

namespace collision_checker      // NOLINT(runtime/indentation_namespace)
{
        /**
        ...
        */
struct MinDistResult        // NOLINT(runtime/indentation_namespace)
{
...
namespace math_utils      // NOLINT(runtime/indentation_namespace)
{
        /**
